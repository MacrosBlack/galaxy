CREATE PROCEDURE [dbo].[prcAdd10SystemsWithCoordinates]
	@Id0 int = 0, @Id640 bigint, @Name0 char(80), @X0 decimal(18,5), @Y0 decimal(18,5), @Z0 decimal(18,5), @Date0 DateTime,
	@Id1 int = 0, @Id641 bigint, @Name1 char(80), @X1 decimal(18,5), @Y1 decimal(18,5), @Z1 decimal(18,5), @Date1 DateTime,
	@Id2 int = 0, @Id642 bigint, @Name2 char(80), @X2 decimal(18,5), @Y2 decimal(18,5), @Z2 decimal(18,5), @Date2 DateTime,
	@Id3 int = 0, @Id643 bigint, @Name3 char(80), @X3 decimal(18,5), @Y3 decimal(18,5), @Z3 decimal(18,5), @Date3 DateTime,
	@Id4 int = 0, @Id644 bigint, @Name4 char(80), @X4 decimal(18,5), @Y4 decimal(18,5), @Z4 decimal(18,5), @Date4 DateTime,
	@Id5 int = 0, @Id645 bigint, @Name5 char(80), @X5 decimal(18,5), @Y5 decimal(18,5), @Z5 decimal(18,5), @Date5 DateTime,
	@Id6 int = 0, @Id646 bigint, @Name6 char(80), @X6 decimal(18,5), @Y6 decimal(18,5), @Z6 decimal(18,5), @Date6 DateTime,
	@Id7 int = 0, @Id647 bigint, @Name7 char(80), @X7 decimal(18,5), @Y7 decimal(18,5), @Z7 decimal(18,5), @Date7 DateTime,
	@Id8 int = 0, @Id648 bigint, @Name8 char(80), @X8 decimal(18,5), @Y8 decimal(18,5), @Z8 decimal(18,5), @Date8 DateTime,
	@Id9 int = 0, @Id649 bigint, @Name9 char(80), @X9 decimal(18,5), @Y9 decimal(18,5), @Z9 decimal(18,5), @Date9 DateTime
	AS
